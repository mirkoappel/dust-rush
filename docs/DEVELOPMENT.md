...
Nitro reicht bei vollem Vorrat für fünf Sekunden tatsächlichen Schub; Beschleunigung und zusätzlich erreichbares Tempo entstehen in der Fahrphysik. Für einen deutlicheren Antritt sind der Nitro-Motorschub und ausschließlich seine Vortriebsgrenze erhöht; die seitliche Haftung und Lenkung bleiben unverändert. Das zusätzliche Nitro-Tempolimit beträgt acht Meter pro Sekunde. Normales Gas, Bremse, Bodenkontakt-Prüfung und die bestehende absolute Sicherheitsgrenze bleiben erhalten. Der zusätzliche Kameraabstand wird nicht mehr durch den Nitro-Schalter vorgegeben: Wenn der Truck unter Nitro wirklich schneller wird, behält die Kamera zunächst träger ihr bisheriges Tempo und der Truck fährt voraus. Ein stärker verzögerter, gedämpfter Nachlauf lässt sie anschließend aufholen, auch wenn bei gleichbleibendem Tempo weiter Nitro gehalten wird. Die Kamera wird dabei nicht absichtlich abgebremst; der größere Vorsprung entsteht durch ihr verzögertes Mitbeschleunigen. Der Abstand ist weich auf höchstens 4,75 Meter zusätzlich begrenzt; die leichte Blickwinkelöffnung folgt diesem Abstand. Nach Loslassen oder leerem Vorrat klingt der Nachlauf sanft ab; normales Gas über den weiterhin gehaltenen Nitro-Knopf erzeugt keinen neuen Effekt. Beim Bremsen nähert sich die Kamera weiterhin etwas und kehrt nach dem Loslassen oder beim Stillstand zum normalen Abstand zurück. Die Kameralogik verschiebt niemals den Truck und fügt kein Wackeln hinzu. Übergänge sind zeitbasiert, in der Pause eingefroren und bei aktivierter Systemeinstellung für reduzierte Bewegung ausgeschaltet. Zurücksetzen verwirft die bisherige Tempo-Historie; Werkstatt und Hauptmenü behalten ihre eigenen Kameras.
...
Die Entwickleranzeige ist zunächst verborgen. Fünf schnelle Tipps auf dieselbe freie Stelle im Spiel blenden unten mittig die FPS-Zahl und den kleinen Knopf „Config“ ein; fünf weitere Tipps blenden beides wieder aus und schließen auch die Detailstatistik sowie das Konfigurationspanel. Die Geste funktioniert ebenso mit Mausklicks. Spielknöpfe, Ziehbewegungen und Mehrfingerbedienung zählen nicht mit. In der Detailstatistik stehen zusätzlich die durchschnittliche Bildzeit und der längste Bildabstand des letzten Halbsekundenfensters. Gemessen werden die tatsächlichen Bildabstände, unabhängig vom begrenzten Physik-Zeitschritt. So werden auch einzelne Ausreißer sichtbar, ohne daraus bereits auf eine bestimmte Ursache zu schließen. „Config“ öffnet links ein scrollbares Seitenpanel mit Reglern für Nitro-Antritt, Zusatztempo und Dauer sowie Kameranachlauf und maximalen Kameraabstand. Änderungen wirken sofort beim Fahren, die aktuellen Zahlen stehen neben den Reglern. „Standardwerte“ setzt alle Werte zurück; ein Neuladen verwirft Testwerte ebenfalls.
