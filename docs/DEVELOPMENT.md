...
Die Physik ist bewusst verzeihend, keine technisch genaue Fahrzeugsimulation. Alle abstimmbaren Fahrzeugwerte stehen gemeinsam im Fahrzeug-Physikprofil und werden der Rennsimulation übergeben. Aus Motorleistung und einer breiten Drehmomentkurve wird bei der aktuellen Drehzahl das Motordrehmoment abgeleitet. Eingelegter Gang, Endübersetzung, Antriebswirkungsgrad und tatsächlicher Reifenradius übersetzen es automatisch in Radkraft; geteilt durch die Fahrzeugmasse ergibt sich der mögliche Vortrieb. Reifenhaftung begrenzt, wie viel davon am Untergrund ankommt. Damit liefert eine kurze Übersetzung mehr Antritt bei weniger Topspeed, eine lange Übersetzung entsprechend weniger Antritt bei höherer mechanischer Grenze. Die Masse wirkt außerdem auf Zusammenstöße und Federung. Der Verbrenner nutzt standardmäßig eine Dreigang-Automatik; im Tuning lassen sich zwei bis sechs Gänge vergleichen. Die erste und letzte Übersetzung bleiben dabei gleich, die Zwischenstufen werden geometrisch verteilt. Drehzahlgrenze, Gangstufen, Endübersetzung und tatsächlicher Reifendurchmesser ergeben die mechanische Geschwindigkeitsgrenze; die Automatik schaltet mit Hysterese, damit sie nicht zwischen zwei Gängen pendelt. Der Vortrieb arbeitet gegen Rollwiderstand sowie den quadratisch mit dem Tempo wachsenden Luftwiderstand. Beide Widerstände lassen sich im Antriebs-Tab als Rollwiderstandskoeffizient und Widerstandsfläche CdA abstimmen. Motorleistung, Gewicht, Drehzahlbereich, Fahrwiderstände und Haftung bestimmen dadurch, wie schnell und ob die mechanische Grenze erreicht wird. „Gasannahme“ beschreibt als Zeitkonstante den Leistungsaufbau nach dem Drücken. „Beschleunigungs-Auslauf“ gibt in Kilometern pro Stunde an, wie weit vor der mechanischen Grenze der Vortrieb weich schwächer wird. Die konfigurierbare Fahrzeughaftung beschreibt vorerst den gesamten Reifensatz und wird mit einem separaten Untergrundfaktor für Asphalt oder Erde multipliziert. Einzelne Reifenmodelle erhalten noch keine festen Haftungswerte. Die angeforderte Bremsverzögerung ist in g angegeben. „Bremsansprache“ bestimmt ihren zeitlichen Kraftaufbau; eine getrennte Brems-Längshaftung begrenzt die tatsächlich übertragbare Verzögerung, ohne zugleich den Kurvengrip anzuheben. Beim Driften sinkt nur die Seitenhaftung; die kombinierte Drift-/Rückwärtsbremse kann längs weiterhin bis zur Brems-Längshaftung verzögern. Gefälle und Stöße können das Tempo kurzzeitig verändern. Die Physik läuft in festen 120-Hz-Schritten; die Darstellung glättet Zwischenstände. Die sichtbare Raddrehung ist gegen stroboskopisches Rückwärtslaufen begrenzt, ohne die physikalische Abrollberechnung zu ändern.
...
Die gemeinsame bearbeitbare Fahrzeugbibliothek liegt unter [design/blender/vehicle-library.blend](../design/blender/vehicle-library.blend): vier Karosserien, fünf Räder, vier Motoren, vier Spoiler und vier Lampensets. Eine beschriftete Übersicht zeigt verknüpfte Instanzen nebeneinander; die Originalmodelle bleiben an ihren Montageursprüngen und sind über einzelne Bearbeitungsansichten isolierbar. Der [Blender-Leitfaden](../design/blender/README.md) erklärt Bearbeitung, geprüften Export und historische Quellen. Das gemeinsame Exportscript erzeugt weiterhin die beiden bestehenden Laufzeitpakete, ohne die Modelle zu verschieben oder eine zusätzliche Blender-Datei anzulegen. Die beiden alten Quelldateien bleiben unverändert als Rückfallebene erhalten.
...
Die Fahrwerkswerte verwenden physikalische Einheiten pro Rad: Die Federkonstante steht in Kilonewton pro Meter, die Dämpfung in Kilonewtonsekunden pro Meter. Zusammen mit der Fahrzeugmasse ergeben sie die Bewegung um die vorgespannte Sollhöhe. Dadurch reagiert derselbe Federsatz bei einem schwereren Truck langsamer und schwingt anders, ohne dass die sichtbare Karosserie im Stand ungewollt absinkt. Der Standard von 97,5 kN/m und 8 kN·s/m pro Rad entspricht dem bisherigen Fahrgefühl bei fünf Tonnen Fahrzeugmasse.

Die Automatik unterbricht den Vortrieb beim Gangwechsel für die einstellbare Schaltzeit und hält jeden neu eingelegten Gang für eine getrennt einstellbare Mindestzeit. Dabei fällt die Motordrehzahl gemäß der neuen Übersetzung ab. Hoch- und Runterschaltpunkt sind als Anteil der eingestellten Drehzahlgrenze konfigurierbar; Hochschalten ist ab 30 Prozent, Runterschalten ab 5 Prozent einstellbar. Die maximale Rückschaltschwelle folgt automatisch dem Hochschaltpunkt und dem größten Drehzahlsprung der gewählten Gangabstufung, mit zwei Prozentpunkten Reserve. Zu hohe Rückschaltwerte werden im Profil und Regler sichtbar abgesenkt; ein größerer Abstand bleibt frei einstellbar. Tonhöhe und Filter des Motors folgen der Drehzahl und der Gasstellung; Wind- und Abrollgeräusch bleiben geschwindigkeitsabhängig.

Nitro reicht bei vollem Vorrat standardmäßig für fünf Sekunden. „Nitro-Leistungsplus“ erhöht während des gesamten Boosts Motorleistung und Drehmoment; einen getrennten künstlichen Startkick gibt es nicht. Die „Drehzahlreserve“ hebt gleichzeitig die mechanische Drehzahl- und Geschwindigkeitsgrenze an. Standard sind 25 Prozent zusätzliche Leistung und 15 Prozent Drehzahlreserve über der normalen Grenze von 6.000 Umdrehungen pro Minute. Einen direkten Regler für das normale Höchsttempo gibt es nicht: Drehzahlgrenze, Übersetzungen und Reifendurchmesser bilden die mechanische Obergrenze; Motorleistung, Gewicht, Haftung, Untergrund, Steigung und Fahrwiderstände bestimmen den Weg dorthin. Gasannahme, Beschleunigungs-Auslauf, Bremsverzögerung, Lenkung und Fahrwerk bleiben separat regelbar. Die Bremsverzögerung wirkt auf normale und Driftbremse, verändert aber weder den Rückwärtsantrieb noch dessen Höchstgeschwindigkeit. Die Lenkstärke skaliert den maximalen Einschlag bei gleichem Analogsignal; der Lenkregler selbst behält seinen vollständigen Weg und seine Rückstellung. Die Kamera verhält sich längs der Fahrtrichtung wie eine eigene Drohne: Sie fliegt mit ihrem bisherigen Tempo weiter und erhält Trucktempo und Abstandsabweichung erst nach der einstellbaren echten Reaktionsverzögerung. Danach beschleunigt oder bremst sie mit getrennt begrenzter Kraft zum Soll-Abstand zurück. Die Ausregelzeit bestimmt unabhängig davon, wie weich die Drohne ihr Zieltempo annähert. Der Soll-Abstand beträgt standardmäßig acht Meter. Um verlorenen Abstand zu schließen, darf die Kamera vorübergehend schneller als der Truck fahren; ihr eigenes einstellbares Höchsttempo begrenzt dieses Aufholen unabhängig von Beschleunigung und Bremskraft. Eine weiche Sichtbarkeitsbegrenzung hält den Truck bei großen Abständen im Bild und verhindert, dass die Kamera beim Bremsen zu dicht auffährt; sie ist kein physischer Maximalabstand der Drohne. Die Blickwinkeländerung folgt dem sichtbaren Abstand. Die Kameralogik verschiebt niemals den Truck und fügt kein Wackeln hinzu. Sie bleibt in der Pause stehen und wird bei reduzierter Bewegung oder beim Zurücksetzen deaktiviert; Werkstatt und Hauptmenü behalten ihre eigenen Kameras.
...
Die Entwickleranzeige ist zunächst verborgen. Fünf schnelle Tipps auf dieselbe freie Stelle im Spiel blenden unten mittig die FPS-Zahl und den kleinen Knopf „Tuning“ ein; fünf weitere Tipps blenden beides wieder aus und schließen auch die Detailstatistik sowie das Tuning-Panel. Die Geste funktioniert ebenso mit Mausklicks. Spielknöpfe, Ziehbewegungen und Mehrfingerbedienung zählen nicht mit. „Tuning“ öffnet links ein verschiebbares Panel mit den Hauptbereichen „Fahrgefühl“ und „Performance“. Das Panel lässt sich an seinen freien Rahmenflächen ziehen; Tabs, Regler und Schalter bleiben normale Bedienelemente. Fahrgefühl nutzt eine einzeilige Icon-Leiste für Antrieb, Fahrwerk, Reifen & Bremse, Nitro und Drohne. Geschwindigkeit, Motordrehzahl und Gang stehen kompakt darunter. Die Drohnen-Reaktionszeit startet bei null Sekunden, bleibt im Tuning aber weiterhin bis drei Sekunden einstellbar. Der Performance-Bereich trennt die fünf Gegner in zwei Schalter: „Gegner darstellen“ blendet nur Modelle und Szenenaktualisierung aus, damit sich die reinen Rendering-Kosten vergleichen lassen. „Gegner simulieren“ pausiert zusätzlich KI-Fahrt und Gegnerkollisionen, sodass keine unsichtbaren Fahrzeuge mehr Hindernisse bewegen. Spieler-Truck, Welt und Hindernisphysik bleiben in beiden Fällen aktiv. „Standardwerte“ setzt die Werte des zentralen Fahrprofils zurück; ein Neuladen verwirft Testwerte ebenfalls.
