...
Die Entwickleranzeige ist zunächst verborgen. Fünf schnelle Tipps auf dieselbe freie Stelle im Spiel blenden unten mittig die FPS-Zahl und den kleinen Knopf „Tuning“ ein; fünf weitere Tipps blenden beides wieder aus und schließen auch die Detailstatistik sowie das Tuning-Panel. Die Geste funktioniert ebenso mit Mausklicks. Spielknöpfe, Ziehbewegungen und Mehrfingerbedienung zählen nicht mit. „Tuning“ öffnet links ein verschiebbares Panel mit den Hauptbereichen „Fahrgefühl“ und „Performance“. Das Panel lässt sich an seinen freien Rahmenflächen ziehen; Tabs, Regler und Schalter bleiben normale Bedienelemente. Fahrgefühl nutzt eine einzeilige Icon-Leiste für Antrieb, Fahrwerk, Reifen & Bremse, Nitro und Drohne. Geschwindigkeit, Motordrehzahl und Gang stehen kompakt darunter. Die Drohnen-Reaktionszeit startet bei null Sekunden, bleibt im Tuning aber weiterhin bis 1,5 Sekunden einstellbar. Der Performance-Bereich kann die fünf Gegner samt Szenenaktualisierung ausblenden, damit FPS, Draw Calls und Dreiecke bei identischer Welt direkt vergleichbar werden; die Gegnerphysik bleibt für diesen reinen Grafikvergleich aktiv. „Standardwerte“ setzt die Werte des zentralen Fahrprofils zurück; ein Neuladen verwirft Testwerte ebenfalls.
