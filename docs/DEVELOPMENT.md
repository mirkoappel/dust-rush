...
Während Nitro tatsächlich Schub gibt, bleibt die Fahrkamera weich etwas weiter hinten und öffnet den Bildwinkel leicht. Beim Loslassen oder leerem Vorrat kehrt sie sanft zum normalen Abstand zurück; normales Gas über den weiterhin gehaltenen Nitro-Knopf verlängert den Effekt nicht. Beim Bremsen nähert sie sich etwas und geht nach dem Loslassen oder beim Stillstand wieder auf Normalabstand. Die Effekte verändern weder Truck-Position noch Fahrphysik und fügen kein Wackeln hinzu. Die Übergänge sind zeitbasiert, in der Pause eingefroren und bei aktivierter Systemeinstellung für reduzierte Bewegung ausgeschaltet; Werkstatt und Hauptmenü verwenden weiter ihre eigenen Kameras.
