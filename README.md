...
**Am Handy:** Links sitzt ein runder, halbtransparenter Joystick etwas oberhalb des unteren Bildschirmrands. Nach oben ziehen gibt stufenlos Gas, nach unten bremst und fährt nach dem Stillstand rückwärts; links und rechts lenken stufenlos. Beim Loslassen springt der Griff in die Mitte, die Lenkung stellt sich gerade und der Truck rollt aus. Rechts liegen zwei runde Knöpfe diagonal im Daumenbereich: Handbremse zum Driften und Nitro für einen kurzen Schub. Der Ring um den Blitz zeigt den Nitro-Vorrat. Er reicht für ungefähr 2,4 Sekunden Schub und lädt nach zwei Sekunden Pause langsam wieder auf. Nitro benötigt Gas und Bodenkontakt; Sprünge entstehen durch den Anlauf, nicht durch künstliches Hochheben. Die Bedienelemente sind fest positioniert und nicht verschiebbar. Die Neigelenkung ist standardmäßig aus und lässt sich optional über das Querformat-Handy im Einstellungsmenü einschalten; erst dann gegebenenfalls den Bewegungssensor erlauben. Grün bedeutet an, ein roter Strich bedeutet aus. Auch dann bleibt der Joystick nutzbar: horizontales Ziehen hat Vorrang vor dem Neigen, vertikales Ziehen dosiert weiter Gas und Bremse. Bei aktiver Neigelenkung gleicht die 3D-Kamera den Horizont sanft aus; die Bedienelemente bleiben fest am Bildschirm. Beim Starten und Fortsetzen wird die aktuelle Haltung als Geradeausstellung übernommen.

**Am Computer:** Mit ← und → lenken, mit der Leertaste Gas geben und mit der linken Umschalttaste bremsen. Die Bildschirmsteuerung ist bei Tastatur und Maus ausgeblendet. Pfeil hoch/runter und WASD funktionieren weiterhin. X hält die Handbremse, C aktiviert Nitro. Es gibt weder automatische Lenkhilfe noch automatisches Gas.
