...
**Am Handy:** Das Gerät quer halten, Play antippen und mit den Bildschirmtasten links und rechts lenken. Die Neigelenkung ist standardmäßig aus und lässt sich optional über das Querformat-Handy im Einstellungsmenü einschalten; erst dann gegebenenfalls den Bewegungssensor erlauben. Grün bedeutet an, ein roter Strich bedeutet aus. Die Lenktasten bleiben auch bei aktiver Neigelenkung verfügbar und haben beim Drücken Vorrang. Die 3D-Kamera rollt bei aktiver Neigelenkung sanft gegen die Handybewegung, damit der Horizont bei normalen Lenkbewegungen im Raum ruhiger bleibt; die Bedienelemente bleiben fest am Bildschirm. In beiden Spielarten gibst du selbst Gas: grünes Pedal halten; das rote Pedal bremst und fährt nach dem Stillstand rückwärts. Bei eingeschalteter Neigelenkung wird beim Starten und Fortsetzen die aktuelle Haltung als Geradeausstellung übernommen.
